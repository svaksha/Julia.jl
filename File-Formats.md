[http://en.wikipedia.org/wiki/List_of_file_formats WP list of file formats]
...
* MachO :: [https://github.com/loladiro/MachO.jl An implementation of the MachO file format].
...
* StrPack.jl :: [https://github.com/pao/StrPack.jl for encoding and decoding binary data streams] and here is some [https://strpackjl.readthedocs.org/ documentation] at readthedocs.org.
* XML :: [https://github.com/ihnorton/LibXML.jl XML parsing] in Julia.
