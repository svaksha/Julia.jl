...
+ [CharibdeOptim.jl](https://github.com/yashcodes/CharibdeOptim.jl) :: A Julia implementation of the cooperative solver Charibde to solve mathematical optimisation problems that uses evolutionary, message passing and interval-based algorithm techniques to run in parallel and exchange bound mode to converges faster than rigorous solvers by an order of magnitude.
   * PUB: Charlie Vanaret, Jean-Baptiste Gotteland, Nicolas Durand, Jean-Marc Alliot. [Hybridization of In-terval CP and Evolutionary Algorithms for Optimizing Difficult Problems](https://hal.archives-ouvertes.fr/hal-01168096/document). 21st International Con-ference on Principles and Practice of Constraint Programming (CP 2015), Aug 2015, Cork, Ireland. hal-01168096
...
+ [RankAggregation.jl](https://github.com/juliohm/RankAggregation.jl) :: Rank aggregation in Julia.
